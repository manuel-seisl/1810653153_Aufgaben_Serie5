...
public class Auto extends Fahrzeug implements Comparable<Auto>
{
    ...
    public Auto(short reifen, Color color, short ps, short tueren, boolean gestartet, short geschwindigkeit, boolean klimaanlage, short airbags){
        super(reifen, color, ps, tueren, false, (short)0);
    ...
    public String toString(){
        return "Mein Auto hat " + this.getPs() +  " PS und fährt mit " + this.getGeschwindigkeit() + " km/h und die Farbe " + this.getColor();
    }
